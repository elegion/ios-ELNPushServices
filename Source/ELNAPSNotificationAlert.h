...
@property (nonatomic, copy, nullable) NSArray *titleLocArgs;
...
@property (nonatomic, copy, nullable) NSString *actionLocKey;
...
@property (nonatomic, copy, nullable) NSString *locKey;
...
@property (nonatomic, copy, nullable) NSArray *locArgs;
